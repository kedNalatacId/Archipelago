...
class IncludeCassettes(DefaultOnToggle):
    """Whether to include cassettes in the item pool or not.
    Setting this to false sets cassettes required to zero."""
    display_name = "Include Cassettes"
...
class IncludeBSides(DefaultOnToggle):
    """Whether to include any B-Side Completion/items in the item pool.
    Disabling this option will also remove all C-Side options from the pool."""
    display_name = "Include B-Sides"


class IncludeCSides(DefaultOnToggle):
    """Whether to include any C-Side Completion/items in the item pool"""
...
celeste_options: Dict[str, type] = {
    ...
    "include_bsides": IncludeBSides,
    "include_csides": IncludeCSides,
